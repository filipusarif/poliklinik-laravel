                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <a href="{{ route('pasien.konsultasi.index') }}" class="btn btn-success shadow-sm float-right mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('pasien.konsultasi.update', $konsultasi->id) }}" enctype="multipart/form-data" id="edit-form">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row border-bottom pb-4 mx-1">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control @error('pertanyaan') is-invalid @enderror"
                                                    name="pertanyaan" id="pertanyaan" required >{{ old('pertanyaan', $konsultasi->pertanyaan) }}</textarea>
                                                @error('pertanyaan')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
