        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm">
                    <a class="opacity-5 text-white" href="{{ route('admin.dashboard') }}">Admin</a>
                </li>
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">
                    @if(Request::is('admin/dokter') || Request::is('admin/dokter/*'))
                        Dokter
                    @elseif(Request::is('admin/pasien') || Request::is('admin/pasien/*'))
                        Pasien
                    @elseif(Request::is('admin/poli') || Request::is('admin/poli/*'))
                        Poli
                    @elseif(Request::is('admin/obat') || Request::is('admin/obat/*'))
                        Obat
                    @elseif(Request::is('admin/profil') || Request::is('admin/profil/*'))
                        Profil
                    @else
                        Dashboard
                    @endif
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4"
                        ...
                        <li class="mb-2">
                            <a href="{{ route('admin.profil.index') }}" class="dropdown-item border-radius-md">Profil Saya</a>
                        </li>
                        <li class="mb-2">
